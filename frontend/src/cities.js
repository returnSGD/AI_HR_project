// Cascading city data: each entry is one province/SAR.
// Province label → array of prefecture-level cities (or districts for HK/MO).
// 直辖市 each get their own entry with just the city name as the sole option
// so the cascading select can auto-resolve: province="北京市" → city="北京".
export const CHINA_CITY_GROUPS = [
  { label: '北京市',   cities: ['北京'] },
  { label: '上海市',   cities: ['上海'] },
  { label: '天津市',   cities: ['天津'] },
  { label: '重庆市',   cities: ['重庆'] },
  {
    label: '广东省',
    cities: ['广州','深圳','珠海','汕头','佛山','东莞','中山','惠州','江门',
             '湛江','茂名','肇庆','韶关','河源','梅州','汕尾','阳江','清远','潮州','揭阳','云浮'],
  },
  {
    label: '浙江省',
  ...
  {
    label: '海南省',
    cities: ['海口','三亚','三沙','儋州','文昌','琼海','万宁','东方','定安','屯昌','澄迈','临高','白沙','昌江','乐东','陵水','保亭','琼中'],
  },
  {
    label: '内蒙古自治区',
  ...
  {
    label: '澳门特别行政区',
    cities: ['花地玛堂区','圣安多尼堂区','大堂区','望德堂区','风顺堂区','嘉模堂区','圣方济各堂区','路凼区'],
  },
]
