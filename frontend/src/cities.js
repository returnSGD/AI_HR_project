// China administrative regions: province → [prefecture-level cities]
// 直辖市 listed as single city; HK/MO listed to district level.
export const CHINA_CITY_GROUPS = [
  ...
  },
  {
    label: '广东省',
    cities: [
      '广州', '深圳', '珠海', '汕头', '佛山', '东莞', '中山',
      '惠州', '江门', '湛江', '茂名', '肇庆', '韶关', '河源',
      '梅州', '汕尾', '阳江', '清远', '潮州', '揭阳', '云浮',
    ],
  },
  {
    label: '浙江省',
  ...
  },
  {
    ...
    cities: [
      ...
      '北碚区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区',
      '合川区', '永川区', '南川区', '璧山区', '铜梁区', '潼南区',
      '荣昌区', '开州区', '梁平区', '綦江区', '大足区',
    ],
  },
  {
