...
const messages = {
  zh: {
    ...
    job: { match: '匹配度', apply: '查看原帖', posted: '发布于', loadingJd: '正在生成职位详情…', matchedSkills: '已具备', missingSkills: '欠缺', optimizeBtn: '✨ 针对此岗位优化我的简历', optimizing: '分析中…', matchTip: '关键词覆盖率：衡量岗位方向与你背景的相关性，帮助你找到合适的方向，并非录取概率' },
  ...
  en: {
    ...
    job: { match: 'Match', apply: 'View Job', posted: 'Posted', loadingJd: 'Generating job details…', matchedSkills: 'Have', missingSkills: 'Missing', optimizeBtn: '✨ Optimize My Resume for This Job', optimizing: 'Analyzing…', matchTip: 'Keyword coverage rate — measures directional fit between your background and the role, not your odds of being hired' },
