...
const messages = {
  zh: {
    ...
    job: { match: '匹配度', apply: '查看原帖', posted: '发布于', loadingJd: '正在生成职位详情…', matchedSkills: '已具备', missingSkills: '欠缺', optimizeBtn: '✨ 针对此岗位优化我的简历', optimizing: '分析中…' },
    section: { jobs: '📊 找到前 {n} 个匹配职位', report: '🤖 AI 诊断报告', generating: '生成中…', complete: '完成 ✓', liveJobs: '个腾讯实时岗' },
  ...
  en: {
    ...
    job: { match: 'Match', apply: 'View Job', posted: 'Posted', loadingJd: 'Generating job details…', matchedSkills: 'Have', missingSkills: 'Missing', optimizeBtn: '✨ Optimize My Resume for This Job', optimizing: 'Analyzing…' },
    section: { jobs: '📊 Top {n} Matches Found', report: '🤖 AI Diagnostic Report', generating: 'Generating…', complete: 'Complete ✓', liveJobs: 'live from Tencent' },
